...
/** Icon riêng cho màn hình dashboard (mockup light/dark). Cùng quy ước với Icon:
 *  KHÔNG set fill/stroke — để CSS quyết định, nhờ đó icon ăn theo theme. */
export const DashIcon = {
  ...
  cpu: (
    <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" /><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.9 4.9 7 7M17 17l2.1 2.1M19.1 4.9 17 7M7 17l-2.1 2.1" /></svg>
  ),
  memory: (
    <svg viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="10" rx="2" /><path d="M7 17v3M12 17v3M17 17v3" /><path d="M8 11h1M12 11h1M16 11h1" /></svg>
  ),
  disk: (
    <svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="12" cy="12" r="2" /></svg>
  ),
  chip: (
    <svg viewBox="0 0 24 24"><rect x="6" y="6" width="12" height="12" rx="1" /><path d="M10 10h4v4h-4z" /><path d="M9 2v4M15 2v4M9 18v4M15 18v4M2 9h4M2 15h4M18 9h4M18 15h4" /></svg>
  ),
  sun: (
